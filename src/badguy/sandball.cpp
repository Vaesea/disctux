...
Sandball::Sandball(const ReaderMapping& reader) :
  WalkingBadguy(reader, "images/creatures/sandball/sandball.sprite", "left", "right"),
  m_fall_speed()
{
  parse_type(reader);
...
std::string
Sandball::get_default_sprite_name() const
{
  switch (m_type)
  {
    case CORRUPTED:
      return "images/creatures/sandball/sandball.sprite";
    default:
...
void
Sandball::on_type_change(int old_type)
{
...
void
Sandball::active_update(float dt_sec)
{
...
bool
Sandball::collision_squished(MovingObject& object)
{
  if (m_frozen)
